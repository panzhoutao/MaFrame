package com.cydroid.coreframe.service;
...
import com.cydroid.coreframe.tool.util.PreferenceConstants;
import com.cydroid.coreframe.tool.util.PreferenceUtils;
...
public abstract class BaseService extends Service {
	...
	private void setNotification(String fromJid, String fromUserId,
		...
		if (isTicker) {
			...
			ticker = author;
		mNotification = new Notification(R.drawable.notification_template_icon_bg, ticker,
