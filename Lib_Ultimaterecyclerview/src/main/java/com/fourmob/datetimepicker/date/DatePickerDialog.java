...
public void show(FragmentManager manager, String tag) {
	...
	public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day) {
		return newInstance(onDateSetListener, year, month, day, true,"完成");
	}
	public static String sdoneButtonString;
	public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate,String donebuttonString) {
		DatePickerDialog datePickerDialog = new DatePickerDialog();
		sdoneButtonString=donebuttonString;
	...
	public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
		...
		if(hindYear){
            ...
            mMonthAndDayView.setVisibility(View.GONE);
            view.findViewById(R.id.topPanel).setVisibility(View.GONE);
		}
		...
		mDoneButton.setText(sdoneButtonString);
		...
		ClearBtn.setVisibility(canclear?View.VISIBLE:View.GONE);
	...
	private boolean hindYear=false;
	public void hindYear(){
		hindYear=true;
	}
	...
	public static abstract interface OnDateSetListener {
		public abstract void onDateSet(DatePickerDialog datePickerDialog, int year, String month, String day);
	}
}